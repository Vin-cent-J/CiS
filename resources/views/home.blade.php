...
<div class="row px-4 my-4 d-flex">
  <a class="col-4 text-decoration-none text-dark mb-3" href="{{ route('pos') }}">
  ...
  <a class="col-4 text-decoration-none text-dark mb-3" href="{{ route('sales')}}">
    <div class="card shadow" style="height: 15rem;">
      <div class="card-body fs-4 d-flex align-items-center">
  ...
  <a class="col-4 text-decoration-none text-dark mb-3" href="{{ route('purchase') }}">
    <div class="card shadow" style="height: 15rem;">
      <div class="card-body fs-4 d-flex align-items-center">
  ...
  <a class="col-4 text-decoration-none text-dark mb-3" href="{{ route('inventory') }}">
    <div class="card shadow" style="height: 15rem;">
      <div class="card-body fs-4 d-flex align-items-center">
  ...
  <a class="col-4 text-decoration-none text-dark mb-3" href="{{ route('report') }}">
    <div class="card shadow" style="height: 15rem;">
      <div class="card-body fs-4 d-flex align-items-center">
